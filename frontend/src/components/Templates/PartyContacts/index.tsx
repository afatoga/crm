...
export const PartyContacts = () => {
  ...
  const [getPartyRelationshipContactsHandler] =
    operations.getPartyRelationshipContacts;
  const [deleteContactHandler] = operations.deleteContact;
  ...
  const extendedPartyRelationshipContacts = useReactiveVar(
    extendedPartyRelationshipContactsVar
  );
    ...
    <>
      ...
      >
        ...
        {extendedPartyRelationshipContacts.length > 0 && (
          <>
            <Typography>
              {t("singleRecord.partyRelationshipContacts")}
            </Typography>
            <MultiLevelList
